...
import { Search, ShoppingCart, Zap, User, LogOut, Settings, ChevronDown, Menu, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center h-16 gap-4">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button className="relative p-2 text-gray-500 hover:text-primary-600 hover:bg-primary-50 rounded-xl transition-colors hidden sm:block">
